...
public class TriviaGameQuestionRepository {
    ...
    public List<QuizQuestion> getQuizQuestions()
    {
        ...
        QuizQuestion quizQuestion2 = new QuizQuestion("In which Danish town was Lego founded?", answersQuestion2, "https://e7.pngegg.com/pngimages/304/551/png-clipart-lego-lego.png");
        ...
        QuizQuestion quizQuestion5 = new QuizQuestion("Which mountain range is found in Switzerland?", answersQuestion5, "https://www.seekpng.com/png/full/41-412919_christmas-tree-clipart-funny-christmas-tree-png-cartoon.png");
        QuizQuestion quizQuestion6 = new QuizQuestion("What country is called \"Land of Fire and Ice\"?", answersQuestion6, "https://www.pngarts.com/files/1/France-PNG-Free-Download.png");
        QuizQuestion quizQuestion7 = new QuizQuestion("Spaghetti, lasagna, ravioli, and cannelloni are typical foods found in the cuisine of which country?", answersQuestion7, "https://www.pngarts.com/files/1/France-PNG-Free-Download.png");
        QuizQuestion quizQuestion8 = new QuizQuestion("What shape is in the center of Switzerland's flag?", answersQuestion8, "https://www.pngarts.com/files/1/France-PNG-Free-Download.png");
        QuizQuestion quizQuestion9 = new QuizQuestion("What country is split into 443 named islands and also holds the territory of Greenland?", answersQuestion9, "https://www.pngarts.com/files/1/France-PNG-Free-Download.png");
        QuizQuestion quizQuestion10 = new QuizQuestion("Before changing to Euros, what currency was used in Germany?", answersQuestion10, "https://www.pngarts.com/files/1/France-PNG-Free-Download.png");
        QuizQuestion quizQuestion11 = new QuizQuestion("What country's cuisine includes dishes such as red beet soup, kielbasa, and pierogi (dumplings)?", answersQuestion11, "https://www.pngarts.com/files/1/France-PNG-Free-Download.png");
        QuizQuestion quizQuestion12 = new QuizQuestion("The Rhine River runs through what country?", answersQuestion12, "https://www.pngarts.com/files/1/France-PNG-Free-Download.png");
        QuizQuestion quizQuestion13 = new QuizQuestion("What country is bordered by Germany, the Czech Republic, Slovakia and the Ukraine?", answersQuestion13, "https://www.pngarts.com/files/1/France-PNG-Free-Download.png");
        QuizQuestion quizQuestion14 = new QuizQuestion("What European country is divided into departments?", answersQuestion14, "https://www.pngarts.com/files/1/France-PNG-Free-Download.png");
        QuizQuestion quizQuestion15 = new QuizQuestion("Which of these countries is considered the world’s oldest republic?", answersQuestion15, "https://www.pngarts.com/files/1/France-PNG-Free-Download.png");
